...
//裁判系统
extern robot_status_t robot_state; //机器人状�?
...
void referee_usart_task(void const * argument)
{
    ...
    while (1)
    {
        ...
        ui_g_DynamicGroup_HightNum->number = chassis_move.chassis_posture_info.chassis_posture_L.leg_length*100;
